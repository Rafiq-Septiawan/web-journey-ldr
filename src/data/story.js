export const storyData = {
  ...
  paragraphs: [
    ...
    "Jarak memang membatasi pertemuan fisik kita, tetapi ia tidak pernah bisa membatasi bagaimana kita tumbuh bersama, mendukung mimpi satu sama lain, dan membangun kepercayaan. Ini adalah kisah tentang kesabaran, komitmen, dan keyakinan bahwa akhir dari perjalanan panjang ini akan sangat indah."
  ],
  images: [
    {
      url: "https://images.unsplash.com/photo-1516589178581-6cd7833ae3b2?auto=format&fit=crop&w=800&q=80",
      caption: "Mengirimkan potongan langit malam yang sama meskipun dari kota yang berbeda."
    },
    {
      url: "https://images.unsplash.com/photo-1490730141103-6cac27aaab94?auto=format&fit=crop&w=800&q=80",
      caption: "Menanti saat di mana kita tidak perlu lagi mengucapkan selamat tinggal di bandara."
    }
  ]
};
